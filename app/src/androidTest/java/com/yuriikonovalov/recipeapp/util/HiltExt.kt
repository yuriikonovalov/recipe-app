...
import com.yuriikonovalov.recipeapp.HiltTestActivity
...
inline fun <reified T : Fragment> launchFragmentInHiltContainer(
    ...
    ActivityScenario.launch<HiltTestActivity>(startActivityIntent).onActivity { activity ->
        ...
        // Solves a navController issue with fragments using navGraphViewModels()
        navHostController?.let { navHostController ->
