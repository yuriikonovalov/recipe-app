...
class SaveRecipeImpl @Inject constructor(private val repository: RecipeRepository) : SaveRecipe {
    override suspend operator fun invoke(id: Int): Resource<Int> {
        return try {
            ...
            if (update) {
                ...
                val recipe = repository.getRemoteRecipe(id).copy(saved = true)
